...
$THEME->layouts = array(
    ...
    // The site home page. // Skill Assessment Modification
    'frontpage' => array(
        'file' => 'ass_frontpage.php',
        'regions' => array('side-pre','side-post','bottom-region'),
        'defaultregion' => 'side-pre',
    ...
    'login' => array(
        'file' => 'ass_login.php', // Skill Assessment Modification
        'regions' => array(),
    ...
    // Lingel Learning Assessment Layout
    'colorfont' => array(
        'file' => 'ass_layout.php',
        'regions' => array('side-pre', 'side-post', 'bottom-region' ),
        'defaultregion' => 'side-pre',
